...
<div id = "app">
  ...
  <!-- Navbar -->
  <nav v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget'?false:true " id="topbar" style="display: none" class="main-header navbar navbar-expand navbar-white navbar-light border-bottom">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ?false:true " id="leftbar" style="display: none;" class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
